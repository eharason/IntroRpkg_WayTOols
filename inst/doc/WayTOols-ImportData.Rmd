---
title: "WayTOols Import Data"
author: "Emily Harason"
date: "`r Sys.Date()`"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{WayTOols Import Data}
...
The following vignette with show the code for individuals to read their own logfile data into the WayTOols package. The example data used here is from one logfile, `User.9w`. Individuals wishing to read more of the logfiles that have been included in the logfile_data data frame can visit the online git repository for WayTOols. The below code first writes an empty data.frame, and then fills it with information from the logfiles. 
